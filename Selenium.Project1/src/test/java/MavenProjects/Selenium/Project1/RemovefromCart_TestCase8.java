...
public class RemovefromCart_TestCase8  extends AmazonLaunch_Quit

{ 
    @Test
    public void updateitem() throws InterruptedException, EncryptedDocumentException, IOException
    {
       ...
       p1.AddToCart();
    	...
    	UpdateIteam u1 = new UpdateIteam(driver);
    	u1.ClickonCart();
    	u1.Deleteitem();
    }
}
