...

{
	...
	public void onTestSuccess(ITestResult result) {
		...
		File Destination  = new File("C:\\Users\\harsh\\eclipse-workspace\\Selenium.Project1\\AmazonPassTestCase\\ashwini" +  Math.random() + " .png");
		try {
	...
	public void onTestFailure(ITestResult result) {
		// TODO Auto-generated method stub
			...
			File Destination = new File("C:\\Users\\harsh\\eclipse-workspace\\Selenium.Project1\\AmazonFailTestCase\\ashwini" +   Math.random() + " .png");
			try {
				FileHandler.copy(Source, Destination);
			} catch (IOException e) {
				// TODO Auto-generated catch block
